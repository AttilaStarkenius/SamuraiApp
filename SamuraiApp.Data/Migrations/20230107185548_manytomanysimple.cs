    ...
    public partial class manytomanysimple : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    SamuraisBattleId = table.Column<int>(type: "int", nullable: false),
                    SamuraisId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_BattleSamurai", x => new { x.SamuraisBattleId, x.SamuraisId });
                    table.ForeignKey(
                        name: "FK_BattleSamurai_Battles_SamuraisBattleId",
                        column: x => x.SamuraisBattleId,
